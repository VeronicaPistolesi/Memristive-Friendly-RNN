...
#datasets = ['SyntheticControl', 'ECG5000', 'Earthquakes', 'FordA']  # Lista dei dataset da esplorare
...
#datasets = ['JapaneseVowels', 'SyntheticControl', 'ECG5000', 'GunPoint', 'Wafer', 'Epilepsy', 'Coffee', 'OSULeaf', 'FordA', 'Earthquakes', 'ShapesAll', 'StandWalkJump', 'HandOutlines']

#datasets = ['FordA', 'Earthquakes', 'ShapesAll', 'StandWalkJump', 'HandOutlines']
    ...
    for model_type, create_model_fn, param_grid in [
        ...
        with open(results_logger_filename, 'w') as results_logger:
            ...
            if best_params:
                ...
                log_results(results_logger, f'Results: MEAN {np.nanmean(acc_ts)} STD {np.nanstd(acc_ts)}')
